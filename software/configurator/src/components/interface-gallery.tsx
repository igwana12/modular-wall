...
const INTERFACES: InterfaceApp[] = [
  ...
  // Mirror
  { name: "Deity Oracle", creator: "sacred.circuits", moduleId: "mirror", sceneId: "deity-oracle", downloads: 6700, rating: 4.8, apis: ["EdgesGeometry", "SphereGeometry", "Points"], libs: ["Three.js", "MediaPipe", "TensorFlow.js"], description: "Rotating face mesh wireframe with teal glow crown orbs. Sacred geometry overlay.", previewBg: "radial-gradient(circle, #2a0a2e 0%, #0a0a14 100%)" },
